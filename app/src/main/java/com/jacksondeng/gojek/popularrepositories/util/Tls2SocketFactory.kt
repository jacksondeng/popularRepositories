...
import com.jacksondeng.gojek.popularrepositories.BuildConfig
 ...
 */
const val TAG_ERROR = "socketFactoryErrorTag"
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP_MR1) {
                try {
                    ...
                    if(BuildConfig.DEBUG)
                        Log.e( TAG_ERROR,"Error while setting TLS 1.2 compatibility")
                }
            }
        }
    }
